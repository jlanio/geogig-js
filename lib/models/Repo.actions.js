...
var Actions = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function log(options) {
      return api.Log(this.joinParams(), options).then(function (result) {
    ...
    get: function get() {
      ...
      return {
        import: function _import(params) {
          return api.Import(_this2._params.set(params));
        },
        export: function _export(params) {
          return api.Export(_this2._params.set(params));
        }
      };
    }
  }, {
    ...
    key: 'lsTree',
    get: function get() {
      return api.LsTree(this._params.set()).then(function (result) {
        return result.response;
      });
    }
  }]);
